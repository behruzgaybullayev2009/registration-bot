...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, bizning Navoi shahar 4-IDUM maktabining ruyxatdan utkazuvchi botiga hush kelibsiz\nbot nma qiladi /help\nRuyxatdan utish /regist\ndasturchi haqida va kolij haqida mlunot /abaut")
    except:
        await message.answer(text="Assalomu alaykum, bizning Navoi shahar 4-IDUM maktabining ruyxatdan utkazuvchi botiga hush kelibsiz\nbot nma qiladi /help\nRuyxatdan utish /regist\ndasturchi haqida va kolij haqida mlunot /abaut")
...
async def is_admin(message:Message):
    await message.answer(text="Bu bot orqali siz Navoi shahar 4-IDUM maktabiga online tarzda ruyxatdan utishingiz mumkin va siz kursatmalarni tug'ri bersangiz")


@dp.message(Command("abaut"))
async def is_admin(message:Message):
    await message.answer(text="Backend Developer G'aybullayev Behruz @classic_boy_08 bot haqida savollar bo'lsa utib qoldirishilar mumkin\nNavoi shahar 4-IDUM maktabiga qabul qilinasiz")
